...
import ramadanSciencesImg from "../../images/ramadan-sciences.jpg"

const RamadanDesSciencesPage = () => {
  return (
    <Layout>
      <Container className="py-5">
        ...
        <Breadcrumb className="mb-4">
          ...
          <Breadcrumb.Item active>Ramadan des Sciences - La Science et l'Innovation au Service de l'Agriculture</Breadcrumb.Item>
        </Breadcrumb>
            ...
            <article>
              <header className="mb-4">
                <h1 className="mb-3" style={{ 
                  fontWeight: '700',
                  color: '#003366'
                }}>Ramadan des Sciences 4ème édition - La Science et l'Innovation au Service de l'Agriculture</h1>
                
                <div className="d-flex flex-wrap gap-3 mb-3">
                  <div className="d-flex align-items-center">
                    <FontAwesomeIcon icon="calendar-alt" className="me-2 text-primary" />
                    <span>15 Mars 2025 - 10h</span>
                  </div>
                  <div className="d-flex align-items-center">
              ...
              <div className="mb-4 text-center">
                <img 
                  src={ramadanSciencesImg} 
                  alt="Ramadan des Sciences 4ème édition - La Science et l'Innovation au Service de l'Agriculture" 
                  style={{ 
                    maxWidth: '100%', 
                    height: 'auto',
                    borderRadius: '8px',
              ...
              <div className="event-details mb-5">
                ...
                <p>
                  ...
                  sous le thème de la Science et l'Innovation au Service de l'Agriculture, dans le cadre de la 4ème édition de Ramadan des Sciences.
                </p>
                ...
                <div className="program-details p-4 mb-4" style={{ backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
                  ...
                  <p>La Science et l'Innovation au Service de l'Agriculture</p>
                  
                  <h3 className="h5 mb-3 mt-4">Intervenants</h3>
                  <ul>
                    <li>Dr. Ouafa ABBA (ONCA)</li>
                    <li>Dr. Nouredine ESSAFI</li>
                  </ul>
                  
                  <h3 className="h5 mb-3 mt-4">Date et Lieu</h3>
                  <p>15 Mars 2025 à 10h - Amphithéâtre des Conférences</p>
...
export const Head = () => <Seo 
  ...
  description="Le Laboratoire Ressources Naturelles et Développement Durables organise une journée scientifique sur l'innovation agricole, avec Dr. Ouafa ABBA (ONCA) et Dr. Nouredine ESSAFI comme intervenants."
/>

export default RamadanDesSciencesPage 